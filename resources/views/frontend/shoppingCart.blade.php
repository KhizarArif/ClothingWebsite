                ...
                <td>
                    <div class="quantity_container">
                        <div class="input-group quantity quantity_div border border-dark rounded">
                                ...
                                <button class="btn " type="button" id="decrement-btn">-</button>
                                <input type="text" class="quantity_value" id="quantity-input" name="quantity" value="1">
                                <button class="btn " type="button" id="increment-btn">+</button>
                           
                        </div>
                    </div>

                </td>
                <td> <b> Rs.3,198.00 </b> </td>
            </tr>
        </tbody>
    </table>
